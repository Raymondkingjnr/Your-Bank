...
const features_data = [
  ...
  {
    id: 1,
    features: "Financial Tools",
    items: [
      {
        title: "Investment Platforms",
        text: "Platforms that allow users to invest in stocks, bonds, mutual funds, and other financial instruments. Examples: Robinhood, E*TRADE.",
      },
      {
        title: "Payment Gateways",
        text: " Services that facilitate online transactions by securely processing payment information between merchants and customers. Examples: PayPal, Stripe.",
      },
      {
        title: "Credit Score Monitoring Services",
        text: "Services that provide users with regular updates on their credit scores and reports. Examples: Credit Karma, Experian",
      },
      {
        title: "Financial News Aggregators",
        text: "Definition: Platforms that curate and provide news and updates related to the financial markets and industry. Examples: Bloomberg, CNBC.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        text: "Customer service helps with inquiries related to account balances, transaction history, and account details. This includes resolving discrepancies and clarifying any confusion regarding the customer's financial information.",
      },
      {
        title: "Transaction Support",
        text: "Assisting customers with transaction-related issues, such as failed transactions, unauthorized charges, and transaction inquiries. This involves investigating and resolving problems to ensure the accuracy and security of transactions.",
      },
      {
        title: "Problem Resolution",
        text: " Addressing and resolving customer complaints and issues. This may involve investigating discrepancies, coordinating with relevant departments, and ensuring a timely and satisfactory resolution to maintain customer satisfaction.",
      },
      {
        title: "Technical Support",
        text: "Assisting customers with technical issues related to online banking platforms, mobile apps, and other digital services. This includes troubleshooting login problems, navigation issues, and providing guidance on using digital banking tools.",
      },
    ],
  },
];
